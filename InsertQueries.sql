...
INSERT INTO clients_contracts (contract_id, client_id, signing_date, expiry_date, payment_date, minutes, megabytes, sms, bill) 
	SELECT 2, 2, "2019-02-01", "2021-02-01", 10, minutes, megabytes, sms, bill FROM contracts c WHERE c.id = 2;

INSERT INTO clients_contracts (contract_id, client_id, signing_date, expiry_date, payment_date, minutes, megabytes, sms, bill) 
	SELECT 1, 3, "2020-05-08", "2022-05-08", 15, minutes, megabytes, sms, bill FROM contracts c WHERE c.id = 1;
    
INSERT INTO clients_contracts (contract_id, client_id, signing_date, expiry_date, payment_date, minutes, megabytes, sms, bill) 
	SELECT 3, 1, "2018-10-15", "2020-10-15", 8, minutes, megabytes, sms, bill FROM contracts c WHERE c.id = 3;
    
INSERT INTO clients_contracts (contract_id, client_id, signing_date, expiry_date, payment_date, minutes, megabytes, sms, bill) 
	SELECT 5, 4, "2020-06-24", "2022-06-24", 23, minutes, megabytes, sms, bill FROM contracts c WHERE c.id = 5;